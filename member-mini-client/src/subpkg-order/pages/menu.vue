...
export default {
  ...
  setup() {
    ...
    const {
      ...
      canCheckout, postpayReadyToSettle, tableStatusView, tableBillPayStateText, isAwaitingPayment, tablePickupNo,
