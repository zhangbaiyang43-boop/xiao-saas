...
.entry-card { width: 100%; min-height: 360rpx; border-radius: 28rpx; background: var(--bg-card); box-shadow: 0 18rpx 48rpx rgba(15, 23, 42, .08); display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 48rpx 36rpx; text-align: center; box-sizing: border-box; }
.entry-card--loading { color: var(--text-1); }
...
.entry-title { margin-top: 28rpx; color: var(--text-1); font-size: 34rpx; font-weight: 900; }
.entry-desc { margin-top: 14rpx; color: #64748b; font-size: 26rpx; line-height: 1.5; }
.entry-btn { margin-top: 36rpx; width: 100%; height: 88rpx; border-radius: 22rpx; background: #16c76f; color: var(--text-inverse); font-size: 30rpx; font-weight: 900; display: flex; align-items: center; justify-content: center; }
</style>
