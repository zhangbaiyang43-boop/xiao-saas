...
export const staffHandoffLogin = (data) => request.post('/v1/login/staff/handoff', data, { withCredentials: true })
export const getStaffWechatStatus = () => request.get('/v1/staff/wechat/status')
export const getStaffMiniprogramStatus = () => request.get('/v1/staff/miniprogram/status')
export const getStaffWechatOauthStart = (params) => request.get('/v1/staff/wechat/oauth/start', { params: { ...params, format: 'json' } })
export const previewStaffWechatBind = (t) => request.get('/v1/staff/wechat/bind/preview', { params: { t } })
export const confirmStaffWechatBind = (data) => request.post('/v1/staff/wechat/bind/confirm', data, { withCredentials: true })
...
export const createWechatBindToken = (id) => request.post(`/v1/merchant-accounts/${id}/wechat-bind-token`)
export const getWechatBindStatus = (id) => request.get(`/v1/merchant-accounts/${id}/wechat-bind-status`)
export const createMiniprogramBindSession = (id) => request.post(`/v1/merchant-accounts/${id}/miniprogram-bind-session`)
export const getMiniprogramBindStatus = (id) => request.get(`/v1/merchant-accounts/${id}/miniprogram-bind-status`)
export const unbindStaffWechat = (id) => request.post(`/v1/merchant-accounts/${id}/wechat-unbind`)
