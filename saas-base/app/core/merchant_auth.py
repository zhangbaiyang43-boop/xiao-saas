...
_STAFF_ROUTE_RULES: list[tuple[str, re.Pattern[str], Optional[str] | tuple[str, ...]]] = [
    ...
    ("POST", re.compile(r"^/api/v1/orders/\d+/serve$"), "order.serve"),
    ("POST", re.compile(r"^/api/v1/orders$"), "order.assisted_add"),
    ("POST", re.compile(r"^/api/v1/payment-handoffs/orders/\d+$"), "order.assisted_add"),
    ("GET", re.compile(r"^/api/v1/payment-handoffs/orders/\d+$"), "order.assisted_add"),
    ("GET", re.compile(r"^/api/v1/menu/items$"), "order.assisted_add"),
    ("GET", re.compile(r"^/api/v1/dining-sessions/active$"), "order.assisted_add"),
